...
class MyApp extends StatelessWidget {
  ...
  var description = "La capital musical de Colombia";
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
        //  body: new DescriptionPlace("Ibagué",4,description)
//          body: Column(
//            children: <Widget>[
//              DescriptionPlace("Ibague",4,description),
//              Review("assets/img/user.png","Camilo Cubillos", "1 review 5 photos", "Que ciudad tan Bonita!!!"),
//              ReviewList()
//            ],
//          ),
        body: Stack(
